...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  {
    title: 'Edit',
    href: route('admin.reservations.edit', props.reservation.id),
  },
];

const form = useForm({
  name: props.reservation.name,
  group: props.reservation.group,
  date: parseDate(props.reservation.plain_date) as any,
  hour_start: props.reservation.hour_start,
  hour_end: props.reservation.hour_end,
  agenda: props.reservation.agenda,
  count: props.reservation.count,
  phone: props.reservation.phone,
  type: props.reservation.type,
  menu_type: props.reservation.menu_type,
})
console.log(props.reservation.menu_type)
</script>
<template>
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-4">
      <h2 class="text-2xl font-semibold">Edit Reservasi</h2>
      <form class="mt-6 grid grid-cols-6 gap-4"
        @submit.prevent="form.put(route('admin.reservations.update', reservation.id))">
